        ...
        >
            ...
            <div className="faq-referendum-notice">
                ...
                <p className="notice-footer">
                    Per informazioni: <a href="https://www.gazzettaufficiale.it/eli/gu/2025/03/31/75/sg/html" target="_blank" rel="noopener noreferrer">
                        <strong>https://www.gazzettaufficiale.it/eli/gu/2025/03/31/75/sg/html</strong>
                    </a>
                </p>
            </div>
        </motion.div>
